...
function ledPanel() {
	...
	this.build = function (id) {
		var text = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : params.default.text;
		var radius = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : params.default.radius;
		...
		// Run timer
		if (params.log) var time = performance.now();
		...
		do {
			...
			for (var i = 0; i < stopHeight; i++) {
				...
				if (typeof dots[i][0] == "undefined") {
					// if not currently filled
	...
	this.animate = function () {
		var dotsPerSecond = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 10;
